...
export default function Container({children}) {
    ...
    const toggleTheme = () => {
        setTheme((prevTheme) =>
            prevTheme === Theme.LIGHT ? Theme.LIGHT : Theme.LIGHT
        );
    };
    ...
    return (
        <div>
            ...
            >
                ...
                <div className="relative flex flex-grow basis-0 items-center space-x-3 hidden md:block  h-[32px]">

                    <img src='https://uploads-ssl.webflow.com/64186faca4f0a0ec048fb2dd/6418916afabf4171978cf0a9_shelf-logo.svg'  style={{width:"100px"}} alt="Image" />
                </div>
