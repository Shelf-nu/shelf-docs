      ...
      >
        ...
        <div className="relative flex basis-0 justify-end gap-6 sm:gap-8 md:flex-grow">
          <button
            ...
            type="button"
            className="w-8 h-8 bg-slate-400 rounded-full  flex items-center justify-center  hover:ring-2 ring-gray-300  transition-all"
          >
            <svg
              ...
              fill="none"
              stroke="currentColor"
              className="w-6 h-6 text-gray-200 dark:text-gray-200"
            >
              <Themed
                dark={
                  <path
