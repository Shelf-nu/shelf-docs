...
{% quick-links %}
{% quick-link title="Getting started" href="/docs" description="Get started with shelf" /%}
{% /quick-links %}
...
[**Website**](https://www.shelf.nu/?ref=github) • [**Documentation**](https://github.com/Shelf-nu/shelf.nu/tree/main/docs) • [**Join our Community**](https://discord.gg/gdPMsSzqCS) • [**Twitter**](https://twitter.com/ShelfQR/?ref=github)
